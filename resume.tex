...
\cvline{}{Senior software engineer with 10+ years in web development, specialising in front-end JavaScript and TypeScript. I've worked across media, travel, and agriculture, building performant, accessible products at companies including the Financial Times and Shopify. As comfortable diving into a Rails backend as I am architecting a React frontend, I bring both technical rigour and a product-focused mindset to everything I build.}
...
\cvitem{Jun. 2024 -- Jul. 2025}{\textbf{På(fyll)} \textit{Remote} -- Senior Software Engineer}
\renewcommand{\listitemsymbol}{\textcolor{black}{-~}}
\cvlistitem{Implemented OAuth social sign-in with Vipps, directly increasing account creation conversions.}
\cvlistitem{Improved website performance, achieving a 4× improvement in blog post load times.}
\cvlistitem{Acted as the most senior engineer in a fully distributed team, aligning people, priorities, and projects across time zones.}
\cvlistitem{Translated business goals into practical technical solutions while keeping user needs central.}
\cvlistitem{Raised overall engineering quality through mentorship, code review, and a focus on clean, maintainable code.}
\cvlistitem{Designed and built scalable, reliable systems architected to grow with the product and business.}

\cvitem{Jul. 2022 -- May 2023}{\textbf{Shopify} \textit{Remote} -- Senior Software Engineer}
\renewcommand{\listitemsymbol}{\textcolor{black}{-~}}
\cvlistitem{Built a hybrid email parsing system combining bespoke rule-based parsers and LLM-powered extraction to handle structured data at scale, processing 40 million requests per day and increasing parsed orders shown in the Shop app by 1.5×.}
...
\cvitem{\textbf{Experienced}}{JavaScript, TypeScript, Jest, Playwright, HTML, CSS, React, Node.js, Git}
\cvitem{\textbf{Intermediate}}{Ruby on Rails, Python, PostgresQL, MySQL}
